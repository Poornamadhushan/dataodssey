      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-5 lg:gap-8">
          ...
          <motion.div
            ...
            className="p-5 sm:p-6 rounded-2xl glass-card border border-purple-500/20"
          >
            <div className="w-10 sm:w-12 h-10 sm:h-12 rounded-xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center mb-4 sm:mb-5">
