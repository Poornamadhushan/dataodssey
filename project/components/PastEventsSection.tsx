    ...
    >
      ...
      >
        ...
        <div className="px-5 py-4 flex items-center justify-between gap-3 bg-[#050816]/90">
          <div>
            <div
              className={`inline-flex items-center text-[10px] font-mono px-2.5 py-1 rounded-full border mb-1.5 ${tag.bg} ${tag.text} ${tag.border}`}
            >
              {photo.tag}
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full glass border border-cyan-500/20 mb-4 sm:mb-6">
              ...
              <span className="text-[10px] sm:text-xs font-mono text-cyan-300/80 tracking-widest uppercase">Past Events</span>
            </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="p-3 sm:p-4">
                    <div
                      className={`inline-flex items-center text-[9px] sm:text-[10px] font-mono px-2 py-0.5 sm:py-1 rounded-full border mb-1.5 ${tag.bg} ${tag.text} ${tag.border}`}
                    >
                      {photo.tag}
                    </div>
                    <p className="text-white/75 text-xs sm:text-sm font-medium leading-snug line-clamp-2">{photo.caption}</p>
                  </div>
          ...
          >
            <a
              ...
              className="group flex items-center gap-2 px-6 sm:px-7 py-3 sm:py-3.5 text-sm font-semibold text-[#050816] bg-cyan-400 hover:bg-cyan-300 rounded-xl transition-all duration-300 shadow-[0_10px_30px_rgba(34,211,238,0.35)]"
            >
              View Event Details
