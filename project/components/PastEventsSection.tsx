        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-white/50 text-sm sm:text-base lg:text-lg max-w-2xl mx-auto px-2">
              Relive the highlights from our inaugural event — where the next generation of Sri Lanka&rsquo;s data science innovators competed, collaborated, and conquered.
            </p>
