...
const OBJECTIVES = [
  {
    ...
    desc: 'Explore how artificial intelligence enhances human creativity, decision-making, and problem-solving.',
    color: 'text-cyan-400',
    bg: 'bg-cyan-500/10',
  ...
  },
  {
    ...
    desc: 'Develop impactful AI and data-driven solutions that address real-world challenges across industries.',
    color: 'text-blue-400',
    bg: 'bg-blue-500/10',
